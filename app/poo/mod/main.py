...
from Classes.TextContactSystem import TextContactSystem
from Classes.OwlContactSystem import OwlContactSystem
from functions.func import send_mass_messages
